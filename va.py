...
import json
import pyaudio
import vosk  # Profesjonalna biblioteka offline


# ==========================================
# ASYSTENT GŁOSOWY I INTELIGENTNY NASŁUCH (VOSK)
# ==========================================
...
def main():
    ...
    while True:
        ...
        # Informacja o aktywnym mikrofonie
        if assistant.listen_active:
            cv2.putText(combined, "[VOSK SŁUCHA - powiedz 'stop' aby zakonczyc]", (20, combined.shape[0] - 30),
